...
const $_cntotal   = 0;
var _variables  = {};
var _variablesApp = _variablesAPP = _variablesapp = {};
var $r = {
      conf_ajax  :   {
                        "url":{
                           "login"   :"php/login.php",
                           "vl"      :"php/vl.php",
                           "proceso" :"php/funciones.php"
                        },
                        "metodo":{
                           "post":  "post",
                           "get":   "get"
      ...
      evento   : function(cual = 'click', aquien, fnc)
      {
         if(typeof fnc == 'function')
            if(typeof aquien == 'object')
            {
               ...
               for (var l = 0; l < eventos.length; l++)
   ...
   window.alert   = $r.alert = function(t,tiempo, elem)
   {
      ...
      if(_td.length > 4)
      {
         ...
         _td[0].remove();
            ...
            _contenedor_modal.style.width    = 'fit-content';
            _contenedor_modal.style.maxWidth = '500px';

            /* posiciones */
            switch (attri.estilo.posicion) 
            {
               case "br":
                  _contenedor_modal.style.bottom   = '5px';
                  _contenedor_modal.style.right    = '5px';
               break;
               case "bc":
                  _contenedor_modal.style.bottom    = '5px';
               ...
               case "bl":
                  _contenedor_modal.style.bottom   = '5px';
                  _contenedor_modal.style.left     = '5px';
               break;
               case "tr":
                  _contenedor_modal.style.top      = '5px';
                  _contenedor_modal.style.right    = '5px';
               break;
               case "tc":
                  _contenedor_modal.style.top       = '5px';
            ...
            /* colores */
            _contenedor_modal.style.margin       = "12px";
            _contenedor_modal.style.boxSizing    = "content-box";
            _contenedor_modal.style.height       = "fit-content";
            switch (attri.estilo.tipo) 
            {
               case "neutro":
                  _contenedor_modal.style.padding      = "5px 46px";
                  _contenedor_modal.style.fontSize     = "0.8rem";
                  _contenedor_modal.style.borderRadius = "2px";
                  _contenedor_modal.style.textAlign    = "center";
                  _contenedor_modal.style.background   = "linear-gradient(-45deg , #5787d5 0%,#af98d7 100%)";
               ...
               case "error":
                  ...
                  _contenedor_modal.style.borderRadius = "2px";
                  _contenedor_modal.style.textAlign    = "center";
                  _contenedor_modal.style.background   = "linear-gradient(135deg,  #d55757 0%,#d798c2 100%)";
                  _contenedor_modal.style.color        = "#ffffff";
               break;
               case "warning":
                  _contenedor_modal.style.padding      = "5px 46px";
                  ...
                  _contenedor_modal.style.borderRadius = "2px";
                  _contenedor_modal.style.textAlign    = "center";
                  _contenedor_modal.style.background   = "linear-gradient(135deg,  #d5ce57 0%,#d7ae98 100%)";
                  _contenedor_modal.style.color        = "#ffffff";
               break;
               case "success":
                  _contenedor_modal.style.padding      = "5px 46px";
                  ...
                  _contenedor_modal.style.borderRadius = "2px";
                  _contenedor_modal.style.textAlign    = "center";
                  _contenedor_modal.style.background   = "linear-gradient(135deg,  #57d575 0%,#98aad7 100%)";
                  _contenedor_modal.style.color        = "#ffffff";
               break;
               case "personal":
                  _contenedor_modal.style.fontSize     = "0.8rem";
